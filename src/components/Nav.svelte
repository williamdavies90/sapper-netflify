...
<nav>
	<ul>
		...
		<li><a class:selected='{segment === "photos"}' href="http://urlgeni.us/instagram/timandlucywedding"><Icon class="test mx-auto d-block" icon={faInstagram}></Icon><span>photos</span></a></li>
